...
const typeTitle = (uincrement) => {
    switch (uincrement.type) {
        case 'Продажба':
            return {
                'title': 'Желаеш ли да приключиш този приход? С броя заявени за продажба прасета ще бъде намален общия брой прасета в процеса. Обявеното тегло ще бъде добавено към общото тегло на продадените, ремонтни или умрели до момента прасета.',
            }
        case 'Ремонт':
            return {
                'title': 'Желаеш ли да приключиш този приход? С броя заявени ремонтни прасета ще бъде намален общия брой прасета в процеса. Обявеното тегло ще бъде добавено към общото тегло на продадените, ремонтни или умрели до момента прасета. В склада ще се добави броя прасета към общия брой ремонтни прасета.',
            }
        case 'Умрели':
            return {
                'title': 'Желаеш ли да приключиш този приход? С броя заявени умрели прасета ще бъде намален общия брой прасета в процеса. Обявеното тегло ще бъде добавено към общото тегло на продадените, ремонтни или умрели до момента прасета.',
            }
        default:
            return {
