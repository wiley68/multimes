...
const totalDecrementsMaterial = computed(() => {
  return parseInt(
    props.udecrements
      .filter(
        (item) => item.status === 1 && item.product?.type === 'Прасета угояване'
      )
...
const totalDecrementsFuraz = computed(() => {
  return parseInt(
    props.udecrements
      .filter(
        (item) => item.status === 1 && item.product?.type === 'Фураж угояване'
      )
  ...
  return parseInt(
    props.uincrements
      .filter(
        (item) =>
          item.status === 1 &&
          item.product?.type === 'Прасета угояване' &&
          item.type === 'Продажба'
      )
      .reduce((total, item) => total + item.quantity, 0)
  )
...
const totalPrirast = computed(() => {
  return parseFloat(
    totalIncementsWeight.value - totalDecrementsMaterialWeight.value
  )
})
</script>
      ...
      <q-card-section class="col">
        <div class="text-subtitle1">
          ...
          <span class="text-weight-light"
            >{{ totalDecrementsMaterial }} бр</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
          ...
          <span class="text-weight-light"
            >{{ totalDecrementsMaterialWeight.toFixed(2) }} кг</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">
        ...
        <div class="text-subtitle1">
          ...
          <span class="text-weight-light"
            >{{ totalDecrementsFurazWeight.toFixed(2) }} кг</span
          >
        </div>
        <q-separator />
        <div class="text-subtitle1">
        ...
        <div class="text-subtitle1">
          ...
          <span class="text-weight-light"
            >{{ totalIncementsSellWeight.toFixed(2) }} кг</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
        ...
        <div class="text-subtitle1">
          ...
          <span class="text-weight-light"
            >{{ totalIncementsRemontWeight.toFixed(2) }} кг</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
        ...
        <div class="text-subtitle1">
          ...
          <span class="text-weight-light"
            >{{ totalIncementsUmreliWeight.toFixed(2) }} кг</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
          ...
          <span class="text-weight-light"
            >{{ totalIncementsWeight.toFixed(2) }} кг</span
          >
        </div>
        <q-separator />
        <div class="text-subtitle1 text-accent">
          <span class="text-weight-medium"
            >Прираст тегло за целия процес:
          </span>
          <span class="text-weight-light"
            >{{ totalPrirast.toFixed(2) }} кг</span
          >
        </div>
        <div class="text-subtitle1 text-accent">
          <span class="text-weight-medium"
            >Съотношение кг фураж за 1кг живо тегло:
          </span>
          <span class="text-weight-light">{{
            totalPrirast !== 0.0
              ? (totalDecrementsFurazWeight / totalPrirast).toFixed(2)
              : '0.00'
          }}</span>
        </div>
        <div class="text-subtitle1 text-accent">
          <span class="text-weight-medium"
            >Смъртност количество умрели прасета:
          </span>
          <span class="text-weight-light">{{ totalIncementsUmreli }} бр</span>
        </div>
        <div class="text-subtitle1 text-accent">
          <span class="text-weight-medium"
            >Смъртност процент умрели спрямо заредени:
          </span>
          <span class="text-weight-light"
            >{{
              totalDecrementsMaterial !== 0.0
                ? (
                    (totalIncementsUmreli / totalDecrementsMaterial) *
                    100
                  ).toFixed(2)
                : '0.00'
            }}
    ...
    <q-card class="my-card full-height column">
      ...
      <q-card-section class="col">
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
            `Текущ брой ${
              uproduction.product ? uproduction.product.name : ''
            }: `
          }}</span>
