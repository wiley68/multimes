...
const totalDecrementsFuraz = computed(() => {
  return parseInt(
    props.mdecrements
      .filter(
        (item) =>
          item.status === 1 && item.product?.type === props.mhallInfo.furaz
      )
    ...
    <q-card class="my-card full-height column">
      ...
      <q-card-section class="col">
        ...
        <div class="text-subtitle1">
          ...
          <span class="text-weight-light"
            >{{ totalIncementsPrehvarliane }} бр</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
          ...
          <span class="text-weight-light"
            >{{ totalIncementsPrehvarlianeWeight.toFixed(2) }} кг</span
          >
        </div>
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
    ...
    <q-card class="my-card full-height column">
      ...
      <q-card-section class="col">
        <div class="text-subtitle1">
          <span class="text-weight-medium">{{
            `Текущ брой ${
              mproduction.product ? mproduction.product.name : ''
            }: `
          }}</span>
        ...
        <div class="text-subtitle1">
          <span class="text-weight-medium"
            >Приходи от прехвърляне на прасета</span
          >
          <span class="text-weight-light"
            >: {{ totalIncrementsPrehvarlianePrice.toFixed(2) }} лв</span
          >
        </div>
        <div class="text-subtitle1">
